  ...
  return (
    <div className="animate-in slide-in-from-right-4 duration-300">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h2 className="text-2xl font-extrabold font-headline">{t('notifications')}</h2>
      </div>
      ...
      <div className="space-y-4 pb-8">
        <div className="bg-surface-container-lowest border-2 border-outline-variant/20 rounded-3xl p-5 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-on-surface text-lg">{t('notif_push_title')}</h3>
              <p className="text-sm text-on-surface-variant mt-0.5">{t('notif_push_desc')}</p>
            </div>
          </div>
        ...
        <div className={`transition-opacity duration-300 ${!settings.push ? 'opacity-50 pointer-events-none' : ''}`}>
          <h4 className="font-bold text-on-surface-variant uppercase text-xs tracking-wider ml-4 mb-3 mt-6">{t('notif_preferences')}</h4>
          ...
          <div className="space-y-3">
            <div className="bg-surface-container-lowest border border-outline-variant/10 rounded-2xl p-4 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-on-surface">{t('notif_health_title')}</h3>
                  <p className="text-sm text-on-surface-variant">{t('notif_health_desc')}</p>
                </div>
              </div>
            ...
            <div className="bg-surface-container-lowest border border-outline-variant/10 rounded-2xl p-4 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-on-surface">{t('notif_activity_title')}</h3>
                  <p className="text-sm text-on-surface-variant">{t('notif_activity_desc')}</p>
                </div>
              </div>
            ...
            <div className="bg-surface-container-lowest border border-outline-variant/10 rounded-2xl p-4 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-bold text-on-surface">{t('notif_promos_title')}</h3>
                  <p className="text-sm text-on-surface-variant">{t('notif_promos_desc')}</p>
                </div>
              </div>
