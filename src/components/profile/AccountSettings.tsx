  ...
  return (
    <div className="animate-in slide-in-from-right-4 duration-300">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h2 className="text-2xl font-extrabold font-headline">Configuración de Cuenta</h2>
      </div>

      <div className="space-y-6">
        <div className="space-y-2">
          <label className="text-sm font-bold text-on-surface-variant uppercase ml-1">Correo Electrónico</label>
          ...
          <p className="text-xs text-on-surface-variant ml-1">El correo no puede modificarse una vez registrado.</p>
        </div>

        <div className="space-y-2">
          <label className="text-sm font-bold text-on-surface-variant uppercase ml-1">Teléfono Móvil</label>
          <div className="relative">
