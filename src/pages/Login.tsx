  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (mode === 'login') {
      if (formData.email === 'usuario' && formData.password === '1111') {
        ...
        setError('Credenciales incorrectas. Intenta con usuario / 1111');
      }
      return;
    }
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-on-surface-variant text-lg max-w-sm leading-relaxed font-medium">
                {mode === 'login' 
                  ? 'Únete a la mejor comunidad de cuidado canino asistido por IA.' 
                  : 'Crea una cuenta personalizada y empieza a entender sus emociones hoy mismo.'}
              </p>
            </div>
          </div>
          ...
          <div className="max-w-md mx-auto w-full">
            <header className="mb-8 text-center">
              ...
              <p className="text-on-surface-variant font-medium">
                {mode === 'login' ? 'Te extrañábamos por aquí.' : 'Regístrate para comenzar la experiencia.'}
              </p>
            </header>
              ...
              >
                ...
                {mode === 'signup' && (
                  <div className="flex flex-col items-center mb-6">
                    ...
                    >
                      {formData.petPhoto ? (
                        ...
                        <div className="flex flex-col items-center text-outline group-hover:text-primary">
                          ...
                          <span className="text-[10px] font-bold uppercase tracking-wider text-center px-2">Foto de <br/>tu perro</span>
                        </div>
                      )}
                      <input 
                        ref={fileInputRef}
                    ...
                    <p className="mt-2 text-[10px] font-bold text-outline uppercase tracking-widest">Opcional pero recomendado</p>
                  </div>
                )}

                {mode === 'signup' && (
                  <div>
                    <label className="block text-[10px] font-black tracking-widest text-on-surface-variant uppercase mb-2 ml-1">Tu Nombre</label>
                ...
                <div>
                  <label className="block text-[10px] font-black tracking-widest text-on-surface-variant uppercase mb-2 ml-1">Usuario / Email</label>
                  <div className="relative">
                    <input 
                      type="text" 
                      required
                ...
                <div>
                  <label className="block text-[10px] font-black tracking-widest text-on-surface-variant uppercase mb-2 ml-1">Contraseña</label>
                  <div className="relative">
                    <input 
                      type="password" 
                      required
            ...
            <div className="mt-8 relative">
              ...
              <div className="relative flex justify-center text-xs"><span className="px-4 bg-white text-outline font-black uppercase tracking-widest">O continúa con</span></div>
            </div>
